...
extern int opt_fanmode;
extern int opt_fanspeed;

extern int opt_heattime;


#define STATIC_URL1_STR     "pool1"
#define STATIC_URL2_STR     "pool2"

#define STATIC_USER1_STR    "worker1"
#define STATIC_USER2_STR    "worker2"
...
extern struct pool_config g_pool_run[];
extern struct pool_config g_pool_conf[];
